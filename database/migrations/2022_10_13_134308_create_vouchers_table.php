...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vouchers', function (Blueprint $table) {
			...
			$table->longText('deskripsi_voucher');
			...
			$table->dateTime('awal_berlaku')->nullable();
			$table->dateTime('akhir_berlaku')->nullable(); //jika awal dan akhir kosong maka berlaku untuk selamanya
