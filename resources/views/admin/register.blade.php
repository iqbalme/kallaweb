...
<html lang="en">
  <head>
    ...
    <title>Tambah User - Kalla Institute</title>
          ...
          <div class="col-md-6">
            <div class="card mb-4 mx-4">
              <div class="card-body p-4">
                <h1>Register</h1>
                <p class="text-medium-emphasis">Tambah User</p>
                ...
                <button class="btn btn-block btn-success" type="submit">Tambah User</button>
				</form>
              </div>
            </div>
          </div>
