    ...
    <div class="row">
		...
		<div class="col-sm-5">
			@if(isset($visi_misi))
				<div class="mb-1 rounded">
					@if($first_visimisi)
						<img src="{{ asset('storage/images/'.$visi_misi) }}" alt="thumbnail prodi" width="200" height="200">
					@else
						<img src="{{ $visi_misi->temporaryUrl() }}" alt="thumbnail prodi" width="200" height="200">
					@endif
				</div>
				<div class="d-grid gap-2 d-md-block mb-3">
    ...
    <div class="row">
		...
		<div class="col-sm-5">
			@if(isset($logo_prodi))
				<div class="mb-1 rounded">
					@if($first_logoprodi)
						<img src="{{ asset('storage/images/'.$logo_prodi) }}" alt="thumbnail prodi" width="200" height="200">
					@else
						<img src="{{ $logo_prodi->temporaryUrl() }}" alt="thumbnail prodi" width="200" height="200">
					@endif
				</div>
				<div class="d-grid gap-2 d-md-block mb-3">
