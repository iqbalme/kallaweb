<div>
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
			<div class="carousel-item active">
				<img class="carousel-gambar" src="https://cms.kallabs.ac.id/storage/app/public/uploads/slider/rVJF4YKLZXhrN2cZ0gzCXtxdWJXu0jVw80T82VSR.jpg">
				<div class="container">
				  <div class="carousel-caption text-left">
					<h1><span style="background-color:rgba(104, 103, 103, 0.8);padding:3px 9px;">Belajar Riset Pasar</span></h1>
					<p class="mt-3"><span style="background-color:rgba(73, 124, 253, 0.53);padding:3px 9px;">Calon mahasiswa belajar di ITB Kalla</span></p>
					<p><a class="btn btn-lg btn-primary" href="#" role="button">Selengkapnya</a></p>
				  </div>
				</div>
			</div>
			<div class="carousel-item">
				<img class="carousel-gambar" src="https://cms.kallabs.ac.id/storage/app/public/uploads/galeri/270.jpg">
				<div class="container">
				  <div class="carousel-caption text-left">
					<h1><span style="background-color:rgba(104, 103, 103, 0.8);padding:3px 9px;">Belajar Tim Pengajar Berkualitas</span></h1>
					<p class="mt-3"><span style="background-color:rgba(73, 124, 253, 0.53);padding:3px 9px;">Perpaduan antara akademisi dan praktisi kewirausahaan dan Manager/Direksi Kalla Group</span></p>
					<p><a class="btn btn-lg btn-primary" href="#" role="button">Selengkapnya</a></p>
				  </div>
				</div>
			</div>
	  ...
	  <div class="whos-speaking-area speakers pad100 mt-5">
		<div class="container">
			<!-- /.row  end-->
			<div class="row mb50">
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
					<div class="speakers xs-mb30">
						<div class="spk-img">
							<img class="img-fluid" src="https://cms.kallabs.ac.id/storage/app/public/uploads/prodi/WhFdPRYNxLqDU36TUNo2OlIAKBxTzNk091FryF1P.png" alt="trainer-img" />
						</div>
						<div class="spk-info">
							<h2>Sistem Informasi</h2>
							<p>Program Studi Sistem Informasi identik dengan mata kuliah menantang yang mengharuskan mahasiswanya untuk "ngoding"</p>
						</div>
					</div>
				</div>
				<!-- /col end-->
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
					<div class="speakers xs-mb30">
						<div class="spk-img">
							<img class="img-fluid" src="https://cms.kallabs.ac.id/storage/app/public/uploads/prodi/bQHgvQUX15TxfAJTsZt0BNl138EoGHJKuA2SRVLj.png" alt="trainer-img" />
						</div>
						<div class="spk-info">
							<h2>Kewirausahaan</h2>
							<p>S1 Kewirausahaan ITBKalla dirancang untuk menghasilkan wirausahawan terdidik dan professional yang inovatif</p>
						</div>
					</div>
				</div>
				<!-- /col end-->
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
					<div class="speakers xs-mb30">
						<div class="spk-img">
							<img class="img-fluid" src="https://cms.kallabs.ac.id/storage/app/public/uploads/prodi/90TfQg96gzOGaDo6MRMO2JtKxD04eQ1dpfDuIwWu.png" alt="trainer-img" />
						</div>
						<div class="spk-info">
							<h2>Manajemen Retail</h2>
							<p>S1 Kewirausahaan ITBKalla dirancang untuk menghasilkan wirausahawan terdidik dan professional yang inovatif</p>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
					<div class="speakers xs-mb30">
						<div class="spk-img">
							<img class="img-fluid" src="https://cms.kallabs.ac.id/storage/app/public/uploads/prodi/ILQuPYknuoek2P9PwoTCciBfEGqmutY4bZ1AQA8m.png" alt="trainer-img" />
						</div>
						<div class="spk-info">
							<h2>Bisnis Digital</h2>
							<p>Prodi Bisnis Digital merupakan Prodi yang mempelajari bisnis dengan menggunakan teknologi digital</p>
						</div>
					</div>
				</div>
				<!-- /col end-->
	...
	<div class="container bootstrap snippets bootdey">
		<div class="row">
			<div class="col-md-12 wp-block no-space arrow-down base no-margin">
				<div class="wp-block-body">
					<h2><strong>SELAMAT DATANG DI</strong></h2>
					<h1><span style="color:#ffff33"><strong>Institut Teknologi dan Bisnis Kalla</strong></span></h1>
					...
					<ul>
						<li>Menyelenggarakan Pendidikan Tinggi dengan tata kelola yang baik, ditunjang Teknologi Informasi dan Sistem Manajemen Mutu</li>
						...
						<li>Membangun sumber daya manusia yang berkarakter insan KALLA, berjiwa kepemimpinan dan kewirausahaan yang berbasis teknologi</li>
					</ul>
				</div>
			</div>
			<div class="col-md-12 wp-block no-space light no-margin">
				<div class="wp-block-body">
					<iframe width="100%" height="400px" src="https://www.youtube.com/embed/dVCJlFXY9r0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
...
<div class="container mt-7">
	...
	<!--end col-->
	  ...
	  <style>
		.carousel-inner > .carousel-item > .carousel-gambar {
		...
		.wp-block.no-space.arrow-bottom.base:after {
		  border-left-color: #3498db;
		}

		.wp-block.no-space.arrow-bottom:after {
		  bottom: 100%;
		  z-index: 300;
		  left: 50%;
