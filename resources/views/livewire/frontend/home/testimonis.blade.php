	...
	<section class="testimonial-section">
        ...
        <div class="swiper-container testimonial-slider swiper-container-fade swiper-container-horizontal swiper-container-wp8-horizontal">
            <div class="swiper-wrapper" style="transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="2" style="width: 778px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                ...
                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 778px; opacity: 1; transform: translate3d(-778px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="row">
                ...
                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" style="width: 778px; opacity: 0; transform: translate3d(-1556px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-6 order-2 order-lg-1 flex align-items-center mt-5 mt-lg-0">
                                <figure class="user-avatar">
                ...
                <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="2" style="width: 778px; opacity: 0; transform: translate3d(-2334px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-6 flex order-2 order-lg-1 align-items-center mt-5 mt-lg-0">
                                <figure class="user-avatar">
            ...
            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 778px; opacity: 0; transform: translate3d(-3112px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-6 order-2 order-lg-1 flex align-items-center mt-5 mt-lg-0">
                                <figure class="user-avatar">
