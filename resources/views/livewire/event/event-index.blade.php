		...
		<div class="card mb-4">
            <div class="card-body">
				<div class="row justify-content-between p-3">
					...
					<div class="col-auto"><button type="button" class="btn btn-success text-white mb-2" data-coreui-toggle="modal" data-coreui-target="#eventModal">Tambah Event</button></div>
					<hr>
				</div>
                    ...
                    <table class="table border mb-0 table-striped">
					  ...
					  @else
                        ...
                        <tr class="align-middle">
						  ...
						  <td class="text-center">
							<span class="badge text-bg-success text-white">{{ date('d-m-Y', strtotime($event->tanggal)) }}</span>
                          ...
                          <td class="text-center">
							<button type="button" class="btn btn-dark" wire:click="getEvent({{ $event->id }})"  data-coreui-toggle="modal" data-coreui-target="#eventModalEdit">Edit</button>
